...
export default async function TeacherCalendarPage() {
  ...
  return (
    <AppLayout role="TEACHER" userName={session.user.name ?? 'Guru'} avatarColor={(session.user as any).avatarColor}>
      ...
      <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-6">
        <div className="space-y-2 fade-in">
          ...
          <p className="text-body-lg text-text-secondary font-medium">
            Kelola jadwal ujian dan tenggat tugas untuk kelas Anda.
          </p>
        </div>

        <CalendarClient role="TEACHER" />
      </div>
    </AppLayout>
  );
}
